...
class Contact(osv.AbstractModel):
    ...
    def record_to_html(
        self, cr, uid, field_name, record, column, options=None, context=None
    ):
        ...
        val = {
            ...
            "country_id": field_browse.country_id
        ...
        # my stuff
        if "inn_kpp" in opf:
            val.update({"inn": field_browse.inn, "kpp": field_browse.kpp})
        ...
        html = (
            ...
            .render(
                cr, uid, "base.contact", val, engine="website.qweb", context=context
            )
            .decode("utf8")
        )
